...
| DS18B20温度传感器 | GPIO02 | 水温检测(1-Wire) |
| TDS水质传感器 | GPIO11/ADC5 | 水质TDS检测 |
| 光敏电阻(LDR) | GPIO12/ADC0 | 环境光检测 |

### 执行器

| 执行器 | 引脚 | 功能说明 |
|--------|------|----------|
| L9110S电机驱动#1(抽水泵) | GPIO00, GPIO01 | 抽水控制 |
| L9110S电机驱动#2(补水泵) | GPIO06, GPIO08 | 补水控制 |
| 加热片 | GPIO10 | 加热控制 |
| PWM风扇 | GPIO04/PWM1 | 散热控制 |
| LED补光灯 | GPIO03 | 补光控制 |
