...
| L9110S电机驱动#2(补水泵) | GPIO05, GPIO06 | 补水控制(双引脚正反转，GPIO05从按键功能改为补水泵控制) |
| 加热片 | GPIO10 | 加热控制 |
...
**注意**: GPIO05原用于按键S1/S2功能，已改为补水泵L9110S的IA引脚。按键功能已移除，OLED显示页面改为自动循环切换。
...
| GPIO05 | 补水泵 L9110S IA | 电机驱动正向控制(原按键功能已移除) |
| GPIO06 | 补水泵 L9110S IB | 电机驱动反向控制 |
| GPIO07 | 水位传感器 | ADC3输入 |
