...
int mqtt_connect(void)
{
	...
	// char *host = "139.9.112.110";
	// char *host = "124.70.50.200";
	char *host = "121.36.35.193"; // MQTT服务器地址
	int port = 1883;
	...
	data.clientID.cstring = "hi3861_gyz"; // 修改成自己名称，
	...
	while (!toStop)
	{
		...
		snprintf(payload, sizeof(payload), "{\"stat\":%d,\"gas\":%d,\"temp\":%.1f,\"hum\":%.1f}",
				 stat, gas, temperature, humidity); // 获取数据并封装为json字符串
